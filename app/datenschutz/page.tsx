export const metadata = {
  title: "Datenschutz | Praxis Dr. Vlachou-Vaterrodt",
};
  ...
  return (
    <main className="legal-page">
      ...
      <article className="legal-content">
        ...
        <p className="legal-lead">Informationen zur Verarbeitung personenbezogener Daten beim Besuch dieser Website.</p>
        <p className="legal-status">Stand: August 2026</p>

        <section>
          <h2>1. Verantwortlicher</h2>
          <p>Verantwortlicher im Sinne der Datenschutz-Grundverordnung (DSGVO) ist:</p>
          <p>Dr. med. Vassiliki Vlachou-Vaterrodt<br />Südliche Münchner Str. 20<br />82031 Grünwald<br />Deutschland</p>
          <p>E-Mail: <a href="mailto:info@augen-arzt.de">info@augen-arzt.de</a><br />Telefon: <a href="tel:+49896492969">089 6492969</a></p>
        </section>
        ...
        <section>
          ...
          <ul>
            <li>IP-Adresse</li><li>Datum und Uhrzeit des Zugriffs</li><li>aufgerufene Seiten und Dateien</li><li>übertragene Datenmenge</li><li>Browsertyp und Browserversion</li><li>verwendetes Betriebssystem</li><li>Referrer-URL</li><li>Hostname des zugreifenden Rechners</li>
          </ul>
          ...
          <p>Weitere Informationen zum Datenschutz bei IONOS finden Sie unter: <a href="https://www.ionos.de/terms-gtc/datenschutzerklaerung/" target="_blank" rel="noreferrer">www.ionos.de/terms-gtc/datenschutzerklaerung/</a>.</p>
        </section>

        <section>
          <h2>4. Cookies und vergleichbare Technologien</h2>
          <p>Diese Website setzt keine Analyse-, Marketing- oder Tracking-Cookies ein. Wir verwenden keine Webanalyse- oder Tracking-Tools wie Google Analytics, Matomo, Meta Pixel, Hotjar oder vergleichbare Dienste.</p>
          <p>Cookies und vergleichbare Technologien werden auf dieser Website ausschließlich durch Cookiebot gesetzt, soweit dies für die Verwaltung, Speicherung und Dokumentation Ihrer Datenschutzeinstellungen erforderlich ist.</p>
        ...
        <section>
          <h2>5. Consent-Management mit Cookiebot</h2>
          ...
          <ul>
            <li>IP-Adresse in gekürzter oder anonymisierter Form</li><li>Datum und Uhrzeit der Einwilligung</li><li>Angaben zum verwendeten Browser</li><li>URL, von der die Einwilligung erteilt wurde</li><li>Einwilligungsstatus</li><li>eine anonyme, zufällig generierte ID</li>
          </ul>
          ...
          <p>Weitere Informationen zum Datenschutz bei Cookiebot finden Sie unter: <a href="https://www.cookiebot.com/de/privacy-policy/" target="_blank" rel="noreferrer">www.cookiebot.com/de/privacy-policy/</a>.</p>
        </section>

        <section>
          <h2>6. Cookie-Erklärung</h2>
          <p>Diese Website verwendet derzeit ausschließlich das technisch notwendige Cookie „CookieConsent“ von Cookiebot, um Ihre Cookie- bzw. Datenschutzeinstellungen zu speichern. Weitere Cookies, insbesondere Analyse-, Marketing- oder Tracking-Cookies, werden nicht eingesetzt.</p>
          <p>Die folgende Übersicht zeigt die auf dieser Website verwendeten Cookies und vergleichbaren Technologien. Sofern dort ausschließlich Cookiebot ausgewiesen wird, entspricht dies der aktuellen technischen Ausgestaltung der Website.</p>
          <p>Sie können Ihre Einwilligung jederzeit mit Wirkung für die Zukunft über den Link „Datenschutzeinstellungen“ ändern oder widerrufen.</p>
          <h3>Notwendig (1)</h3>
          <p>Notwendige Cookies helfen dabei, eine Webseite nutzbar zu machen, indem sie Grundfunktionen wie die Speicherung Ihrer Cookie-Einstellungen ermöglichen. Die Webseite kann ohne diese Cookies nicht richtig funktionieren.</p>
          <div className="cookie-table-wrap"><table className="cookie-table"><thead><tr><th>Name</th><th>Anbieter</th><th>Zweck</th><th>Maximale Speicherdauer</th><th>Typ</th></tr></thead><tbody><tr><td>CookieConsent</td><td>www.augen-arzt.de</td><td>Speichert den Zustimmungsstatus des Benutzers für Cookies auf der aktuellen Domäne.</td><td>1 Jahr</td><td>HTTP-Cookie</td></tr></tbody></table></div>
        </section>
        ...
        <section>
          ...
          <ul><li>Name</li><li>Kontaktdaten</li><li>Inhalt Ihrer Anfrage</li><li>Zeitpunkt der Kontaktaufnahme</li><li>gegebenenfalls weitere von Ihnen freiwillig übermittelte Informationen</li></ul>
        ...
        <section>
          <h2>8. Empfänger personenbezogener Daten</h2>
          ...
          <ul><li>Hosting-Anbieter</li><li>technische Dienstleister</li><li>Anbieter des Consent-Management-Tools</li><li>Anbieter eingebundener Dienste, sofern Sie diese aktiv nutzen</li></ul>
        ...
        <section>
          ...
          <ul><li>Recht auf Auskunft über die von uns verarbeiteten personenbezogenen Daten gemäß Art. 15 DSGVO</li><li>Recht auf Berichtigung unrichtiger personenbezogener Daten gemäß Art. 16 DSGVO</li><li>Recht auf Löschung personenbezogener Daten gemäß Art. 17 DSGVO</li><li>Recht auf Einschränkung der Verarbeitung gemäß Art. 18 DSGVO</li><li>Recht auf Datenübertragbarkeit gemäß Art. 20 DSGVO</li><li>Recht auf Widerspruch gegen bestimmte Verarbeitungen gemäß Art. 21 DSGVO</li><li>Recht auf Widerruf einer erteilten Einwilligung gemäß Art. 7 Abs. 3 DSGVO</li></ul>
        ...
        <section>
          ...
          <p>Website: <a href="https://www.lda.bayern.de" target="_blank" rel="noreferrer">www.lda.bayern.de</a></p>
          <p>Online-Beschwerde: über das Beschwerdeformular des BayLDA auf <a href="https://www.lda.bayern.de" target="_blank" rel="noreferrer">www.lda.bayern.de</a></p>
        </section>
        ...
        <section>
          <h2>15. Kontakt bei Datenschutzfragen</h2>
          <p>Bei Fragen zum Datenschutz wenden Sie sich bitte an:</p>
          <p>Dr. med. Vassiliki Vlachou-Vaterrodt<br />Südliche Münchner Str. 20<br />82031 Grünwald<br />Deutschland</p>
          <p>E-Mail: <a href="mailto:info@augen-arzt.de">info@augen-arzt.de</a><br />Telefon: <a href="tel:+49896492969">089 6492969</a></p>
        </section>
      </article>
      <footer><span>© {new Date().getFullYear()} Praxis Dr. Vlachou-Vaterrodt</span><div><a href="/impressum">Impressum</a><a href="/">Startseite</a></div></footer>
    </main>
  );
}
